...
public:
	...
	friend CBigInteger operator + (const CBigInteger& b1, const CBigInteger& b2) ;
	...
	friend std::ostream & operator << (std::ostream & os, CBigInteger& b);

	friend std::istream & operator >> (std::istream & is, CBigInteger& b);
