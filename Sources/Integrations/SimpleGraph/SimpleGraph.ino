...
#define TIME_OFFSET 7200      // Time offset (7200 seconds as an example for Warsaw)
/*------------------*/
...
String strFileName = "MYTELEMETRYGRAPH"; // << Filename
...
void loop()
{
  ...
  // Obtain the time from NTP server
