...
' EXAMPLE: "0100000050120119172a610421a6c3011dd330d9df07b63616c2cc1f1cd00200000000006657a9252aacd5c0b2940996ecff952228c3067cc38d4885efb5a4ac4247e9f337221b4d4c86041b0000000000000000000000000000000000000000000000004c86040000000000100"
...
START_POS=RIGHT(INPUTPAYLOAD,LENP-152-63)
ITERATIONS=100 
DEF I2HEX(lValue)
hexString = ""    
For i = 0 To 3
...
ENDDEF 
OUTPUTPAYLOAD="-1"
VSTARTPOS=VAL(START_POS)
FOR Z = VSTARTPOS TO VSTARTPOS+ITERATIONS
    PRINT Z;
    NONCE = Z
